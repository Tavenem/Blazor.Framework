...
.button-group {
    ...
    --button-inherited-border-color: var(--tavenem-theme-color);
    --button-inherited-color: var(--tavenem-theme-color, var(--tavenem-color-text));
    --button-inherited-font-size-icon: 1.25rem;
    --button-inherited-hover-bg: var(--tavenem-theme-color-hover, var(--tavenem-color-action-hover-bg));
    --button-inherited-hover-color: var(--tavenem-theme-color, var(--tavenem-color-action));
