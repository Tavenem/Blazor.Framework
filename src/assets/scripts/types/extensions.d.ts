...
export module 'prosemirror-model' {
    /**
    ...
    export { ProsemirrorNode as PMNode }

    export class TextNode<S extends Schema = any> extends ProsemirrorNode<S> {
        /**
         * Create a copy of this node, with the given text.
         */
        withText(text: string): TextNode<S>;
        /**
         ...
         * of the node's own marks.
         */
        mark(marks: Array<Mark<S>>): TextNode<S>;
        /**
         * Create a copy of this node with only the content between the
         * given positions. If `to` is not given, it defaults to the end of
         * the node.
         */
        cut(from: number = 0, to?: number): TextNode<S>;
    }
    /**
    ...
    export class Schema<N extends string = any, M extends string = any> {
        ...
        nodeType(name: string): NodeType<Schema<N, M>>;
    }
...
export module 'prosemirror-markdown' {
    /**
