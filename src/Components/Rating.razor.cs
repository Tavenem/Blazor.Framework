...
public partial class Rating
{
    ...
    private byte _maxValue = 5;
    /// <summary>
    /// <para>
    /// The maximum value (number of rating icons).
    /// </para>
    /// <para>
    /// Must be between 1 and 255. Setting it to zero results in a value of 1, and setting it above
    /// 255 results in 255.
    /// </para>
    /// </summary>
    [Parameter]
    ...
    private async Task OnKeyDownAsync(KeyboardEventArgs e)
    {
        ...
        switch (e.Key)
        {
            ...
            case "ArrowRight":
                if (e.ShiftKey)
                {
                    await OnValueUpAsync(MaxValue - Value);
                }
                else
                {
